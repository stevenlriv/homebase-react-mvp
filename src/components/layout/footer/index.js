                                ...
                                <div className="col-lg-3 col-sm-6">
                                    <div className="widget widget_social">
                                        ...
                                        <ul className="list-unstyled social-list">
                                            <li><NavLink to="/facebook"><span className="facebook"><i className="fab fa-facebook-f" /></span> Facebook</NavLink></li>
                                            <li><NavLink to="/instagram"><span className="instagram"><i className="fab fa-instagram" /></span> Instagram</NavLink></li>
                                            {/*
